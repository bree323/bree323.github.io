 ...
 * @Descripton: 
 * @LastEditTime: 2021-12-20 02:43:59
-->
<script setup>
...
var getSeriesOption = (data, trafficWay) => [
  {
    name: '',
    type: 'pie',
    clockWise: true,
...
const option1 = {
  ...
  series: getSeriesOption(data1, trafficWay1),
}
const option2 = {
  // backgroundColor: '',
  color: color,
  ...
  series: getSeriesOption(data2, trafficWay2),
}
...
<template>
  <div class="bg-main slidev-layout">
    ...
    <div class="my-auto z-10">
      <h1 style="width: 50px; text-align:center; height: 50px">项目统计</h1>
      <!-- <div class="img"></div> -->
